...
/*PRACTICE QUESTIONS
    ...
    Use the below table and answer the following questions.
    ...
    1. Select ItemID and ItemName from the table and order by ItemID descending
    2. Select ItemName and Price from the table and order by Price ascending
*/
